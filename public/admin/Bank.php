<?php
    ...
    $title = 'QUẢN LÝ NGÂN HÀNG | '.$PNH->site('tenweb');
        ...
        <div class="row">
                    ...
                    <div class="card-body">
                        <form action="" method="POST">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <div class="form-line">
                                        <input type="text" name="api_bank" placeholder="VD: B02A9706-65B3-65BB-7C3B-C3B8E523D5D0" value="<?=$PNH->site('api_bank');?>"
                                            class="form-control">
                                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <div class="form-line">
                                        <input type="text" name="stk_bank" value="<?=$PNH->site('stk_bank');?>"
                                            class="form-control">
                                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <div class="form-line">
                                        <input type="text" name="mk_bank" value="<?=$PNH->site('mk_bank');?>"
                                            class="form-control">
                                    </div>
                                    <i>Chỉ áp dụng cho WEB2M</i>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select class="custom-select" name="type_bank">
                                        <option value="<?=$PNH->site('type_bank');?>"><?=$PNH->site('type_bank');?></option>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select class="custom-select" name="status_cron_bank">
                                        <option value="ON" <?=$PNH->site('status_cron_bank') == 'ON' ? 'selected' : '';?> >ON</option>
                                        <option value="OFF" <?=$PNH->site('status_cron_bank') == 'OFF' ? 'selected' : '';?> >OFF</option>
                                    </select>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <div class="form-line">
                                        <input type="text" name="api_momo" placeholder="VD: 78A76A10-6DA98-B4BA-6079-07953B4D1F74" value="<?=$PNH->site('api_momo');?>"
                                            class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <div class="form-line">
                                        <input type="text" name="sdt_momo" placeholder="VD: 0964347258"
                                            value="<?=$PNH->site('sdt_momo');?>" class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <div class="form-line">
                                        <input type="text" name="name_momo" placeholder="VD: NGUYEN TAN THANH"
                                            value="<?=$PNH->site('name_momo');?>" class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select class="custom-select" name="status_cron_momo">
                                        <option value="ON" <?=$PNH->site('status_cron_momo') == 'ON' ? 'selected' : '';?> >ON</option>
                                        <option value="OFF" <?=$PNH->site('status_cron_momo') == 'OFF' ? 'selected' : '';?> >OFF</option>
                                    </select>
                                ...
                                <div class="col-sm-9">
                                    <div class="form-line">
                                        <input type="number" name="recharge_min" placeholder="VD: 1000"
                                            value="<?=$PNH->site('recharge_min');?>" class="form-control">
                                    </div>
                                ...
                                <div class="col-sm-9">
                                    <div class="form-line">
                                        <input type="text" name="noidung_naptien" placeholder="VD: NAPTIEN"
                                            value="<?=$PNH->site('noidung_naptien');?>" class="form-control">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="table-responsive">
                            <table id="datatable" class="table table-bordered table-striped table-hover">
                                ...
                                <tbody>
                                    <?php
                                    $i = 1;
                                    foreach($PNH->get_list(" SELECT * FROM `bank` WHERE `id` IS NOT NULL ORDER BY id DESC ") as $row){
                                    ?>
                                    <tr>
                                        <td><?=$row['name'];?></td>
                                        ...
                                        <td>
                                            <a type="button" href="#" data-toggle="modal"
                                                ...
                                                <span>EDIT</span></a>
                                            <a type="button"
                                                href="<?=BASE_URL('public/admin/Bank/'.$row['id']);?>"
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="datatable1" class="table table-bordered table-striped table-hover">
                                ...
                                <tbody>
                                    <?php $i = 1; foreach($PNH->get_list(" SELECT * FROM `bank_auto` WHERE `username` IS NOT NULL ORDER BY id DESC LIMIT 100 ") as $row){ ?>
                                    <tr>
                                        <td width="5%"><?=$i++;?></td>
            ...
            <div class="col-md-12">
                <div class="card card-outline card-primary">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="datatable2" class="table table-bordered table-checkable table-striped table-hover">
                                <thead>
                                    <tr>
                                        <th>STT</th>
                                        <th>USERNAME</th>
                                ...
                                <tbody>
                                    <?php $i = 1; foreach($PNH->get_list(" SELECT * FROM `momo` WHERE `username` IS NOT NULL ORDER BY id DESC LIMIT 100 ") as $row){ ?>
                                    <tr>
                                        <td width="5%"><?=$i++;?></td>
                                        <td><a href="<?=BASE_URL('Admin/User/Edit/'.$PNH->getUser($row['username'])['id']);?>"><?=$row['username'];?></a></td>
                                        <td><?=$row['tranId'];?></td>
