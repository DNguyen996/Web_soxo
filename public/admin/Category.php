<?php
    ...
    CheckLogin();
    CheckAdmin();
    $title = 'QUẢN LÝ CHUYÊN MỤC | '.$PNH->site('tenweb');
    ...
    if(isset($_POST['XoaChuyenMuc']) && $getUser['level'] == 'admin' )
    {
        ...
        $row = $PNH->get_row("SELECT * FROM `category` WHERE `id` = '$id' ");
        if(!$row)
        {
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table id="datatable1" class="table table-bordered table-striped table-hover">
                                ...
                                <tbody>
                                    <?php
                                    $i = 1; foreach($PNH->get_list(" SELECT * FROM `category` ORDER BY id DESC ") as $row){ ?>
                                    <tr>
                                        <td><?=$row['stt'];?></td>
